...
Your code lives on GitHub: https://github.com/chinnajp/mylocalvoice  
...
```powershell
git clone https://github.com/chinnajp/mylocalvoice.git
cd mylocalvoice
npm install
npm run sync
npm run dev
...
| Live demo | https://mylocalvoice.vercel.app |
