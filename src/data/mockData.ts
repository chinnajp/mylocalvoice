...
export const mockComplaints: Complaint[] = [
  ...
  },
  {
    ...
    location: { lat: 13.2112, lng: 79.8358, address: 'Thiruppair Kaalani', areaId: 'thiruppair-kaalani' },
    status: 'submitted',
    supporters: 41,
    supporterIds: [],
    comments: [],
  ...
  },
  {
    ...
    location: { lat: 13.2125, lng: 79.8322, address: 'Parikulam', areaId: 'parikulam' },
    status: 'assigned',
    supporters: 33,
    supporterIds: [],
    comments: [],
  ...
  },
  {
    ...
    photos: [],
    location: { lat: 13.2115, lng: 79.8360, address: 'Thiruppair Kaalani North', areaId: 'thiruppair-kaalani' },
    status: 'in_progress',
    supporters: 15,
    supporterIds: [],
    comments: [],
